...
```bash
# Regenerate scripts/docstring_models.py from updated schema
...
Add/update the module docstring in `scripts/docstring_models.py`:
...
uv run ruff format scripts/docstring_models.py

# Check for issues
uv run ruff check scripts/docstring_models.py
...
Add tests for new fields in `scripts/test/test_docstring_models.py`:
...
uv run pytest scripts/test/test_docstring_models.py scripts/test/test_docstring_parser.py -v
...
git add scripts/docstring_models.py
git add scripts/docstring_parser.py
git add scripts/test/test_docstring_models.py
...
- Models: `scripts/docstring_models.py`
- Parser: `scripts/docstring_parser.py`
- Validator: `scripts/unified_validator.py`
- Tests: `scripts/test/test_docstring_models.py`, `scripts/test/test_docstring_parser.py`
