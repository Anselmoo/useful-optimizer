...
Snow Geese Algorithm (SGA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`snow_geese.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/snow_geese.py)
:::
