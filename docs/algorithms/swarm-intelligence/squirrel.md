...
Squirrel Search Algorithm (SSA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`squirrel_search.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/squirrel_search.py)
:::
