...
Mountain Gazelle Optimizer (MGO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`mountain_gazelle.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/mountain_gazelle.py)
:::
