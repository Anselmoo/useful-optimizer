...
Chimp Optimization Algorithm (ChOA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`chimp_optimization.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/chimp_optimization.py)
:::
