...
Reptile Search Algorithm (RSA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`reptile_search.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/reptile_search.py)
:::
