...
Sand Cat Swarm Optimization (SCSO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`sand_cat.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/sand_cat.py)
:::
