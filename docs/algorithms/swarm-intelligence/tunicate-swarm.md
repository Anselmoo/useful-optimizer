...
Tunicate Swarm Algorithm (TSA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`tunicate_swarm.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/tunicate_swarm.py)
:::
