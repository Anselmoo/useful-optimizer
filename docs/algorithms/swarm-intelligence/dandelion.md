...
Dandelion Optimizer (DO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`dandelion_optimizer.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/dandelion_optimizer.py)
:::
