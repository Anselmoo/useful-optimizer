...
Moth Search Algorithm (MS) optimization algorithm.
...
::: tip Source Code
View the implementation: [`moth_search.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/moth_search.py)
:::
