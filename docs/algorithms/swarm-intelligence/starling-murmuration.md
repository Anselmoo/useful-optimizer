...
Starling Murmuration Optimizer (SMO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`starling_murmuration.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/starling_murmuration.py)
:::
