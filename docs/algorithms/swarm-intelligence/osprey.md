...
Osprey Optimization Algorithm (OOA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`osprey_optimizer.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/osprey_optimizer.py)
:::
