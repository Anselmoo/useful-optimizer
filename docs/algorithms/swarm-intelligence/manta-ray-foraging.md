...
Manta Ray Foraging Optimization (MRFO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`manta_ray.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/manta_ray.py)
:::
