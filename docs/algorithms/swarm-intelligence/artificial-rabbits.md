...
Artificial Rabbits Optimization (ARO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`artificial_rabbits.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/artificial_rabbits.py)
:::
