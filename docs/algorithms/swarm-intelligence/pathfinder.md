...
Pathfinder Algorithm (PFA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`pathfinder.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/pathfinder.py)
:::
