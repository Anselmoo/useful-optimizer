...
Wild Horse Optimizer (WHO) optimization algorithm.
...
::: tip Source Code
View the implementation: [`wild_horse.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/wild_horse.py)
:::
