...
Coati Optimization Algorithm (COA) optimization algorithm.
...
::: tip Source Code
View the implementation: [`coati_optimizer.py`](https://github.com/Anselmoo/useful-optimizer/blob/main/src/opt/swarm_intelligence/coati_optimizer.py)
:::
