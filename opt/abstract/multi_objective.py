...
class AbstractMultiObjectiveOptimizer(ABC):
    ...
    def benchmark(
        ...
        **kwargs: object,
        ...
        Returns:
            dict: Result dictionary containing metadata, params, pareto_solutions, pareto_fitness and history (if available).
        """
        import time
        ...
        try:
            ...
            if store:
                # Build schema-compliant artifact for multi-objective
                import datetime
                import sys
