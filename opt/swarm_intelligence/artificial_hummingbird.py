...
class ArtificialHummingbirdAlgorithm(AbstractOptimizer):
    r"""Artificial Hummingbird Algorithm (AHA) optimization algorithm.
    ...
    Example:
        ...
        ...     ArtificialHummingbirdAlgorithm, shifted_ackley, -32.768, 32.768,
    ...
    def __init__(
        ...
        """Initialize the ArtificialHummingbirdAlgorithm optimizer."""
...
if __name__ == "__main__":
    ...
    run_demo(ArtificialHummingbirdAlgorithm)
