...
class StarlingMurmurationOptimizer(AbstractOptimizer):
    r"""Starling Murmuration Optimizer (SMO) optimization algorithm.
    ...
    Example:
        ...
        ...     StarlingMurmurationOptimizer, shifted_ackley, -32.768, 32.768,
...
if __name__ == "__main__":
    ...
    run_demo(StarlingMurmurationOptimizer)
