...
class CoatiOptimizer(AbstractOptimizer):
    r"""Coati Optimization Algorithm (COA) optimization algorithm.
    ...
    Example:
        ...
        ...     CoatiOptimizer, shifted_ackley, -32.768, 32.768, dim=2, max_iter=50, seed=42
        ... )
    ...
    def __init__(
        ...
        """Initialize the CoatiOptimizer optimizer."""
