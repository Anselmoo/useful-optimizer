...
class ArtificialRabbitsOptimizer(AbstractOptimizer):
    r"""Artificial Rabbits Optimization (ARO) optimization algorithm.
    ...
    Example:
        ...
        ...     ArtificialRabbitsOptimizer, shifted_ackley, -32.768, 32.768,
...
if __name__ == "__main__":
    ...
    run_demo(ArtificialRabbitsOptimizer)
