"""JSON Schema models for validating and structuring optimizer docstrings in Google style for the useful-optimizer library."""
...
class Property(Enum):
    ...
    convergence_guaranteed = "Convergence guaranteed"
...
class Exception(BaseModel):  # noqa: A001
